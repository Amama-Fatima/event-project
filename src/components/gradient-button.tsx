...
interface ButtonRotatingBackgroundGradientProps
...
const GradientButton = ({
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-gray-950 px-8 py-1 text-sm font-medium text-gray-50 backdrop-blur-3xl",
          spanClassName
        )}
      >
        {children}
